...
BEGIN
  ...
  INSERT INTO expected (
    ...
    (1, '["Extract","CheckXUExtractionStatus","StoreXUExtractionLog","TestDuplicates","ProcessADLS","Load2Base","ProcessBase"]', '{}'),
    (2, '["Extract","CheckXUExtractionStatus","StoreXUExtractionLog","TestDuplicates","ProcessADLS","Load2Base","ProcessBase"]', '{}');
...
-- select  *  FROM dbo.get_scheduled_entity_batch_activities(
--     0, '2023-06-01', 0
--   )
...
-- select * FROM dbo.[tvf_entity_file_required_activities](0)

-- select * FROM [dbo].[tvf_entity_file_activity_requirements](0)

--   -- batch
--   select * from [dbo].[tvf_entity_file_activity_isRequired](0)

--   -- schedule
--   select * from [dbo].[tvf_entity_scheduled]()
