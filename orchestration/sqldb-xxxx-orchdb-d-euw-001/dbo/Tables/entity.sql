...
(
	...
	[edw_sproc_schema_name]		VARCHAR(128),
	[edw_sproc_name]			VARCHAR(128),
	[edw_source_schema_name]	VARCHAR(128),
	[edw_source_view_name]		VARCHAR(128),
	[edw_dest_schema_name]		VARCHAR(128),
	[edw_dest_table_name]		VARCHAR(112),
	[edw_execution_order]		INT,	
