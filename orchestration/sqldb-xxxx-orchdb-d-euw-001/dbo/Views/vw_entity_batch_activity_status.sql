...
SELECT
	...
	,e.[edw_sproc_schema_name]	AS [sproc_schema_name]
	,e.[edw_sproc_name]			AS [sproc_name]
	,e.[edw_source_schema_name]	AS [source_schema_name]
	,e.[edw_source_view_name]		AS [source_view_name]
	,e.[edw_dest_schema_name]		AS [dest_schema_name]
	,e.[edw_dest_table_name]		AS [dest_table_name]
	,e.[edw_execution_order]		AS [execution_order]
