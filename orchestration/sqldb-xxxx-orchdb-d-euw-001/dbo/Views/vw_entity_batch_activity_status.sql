...
SELECT
	...
	,e.[sproc_schema_name]	AS [sproc_schema_name]
	,e.[sproc_name]			AS [sproc_name]
	,e.[source_schema_name]	AS [source_schema_name]
	,e.[source_view_name]		AS [source_view_name]
	,e.[dest_schema_name]		AS [dest_schema_name]
	,e.[dest_table_name]		AS [dest_table_name]
	,e.[execution_order]		AS [execution_order]
