...
SELECT
	...
	,ent.[sproc_schema_name]	AS [sproc_schema_name]
	,ent.[sproc_name]			AS [sproc_name]
	,ent.[source_schema_name]	AS [source_schema_name]
	,ent.[source_view_name]		AS [source_view_name]
	,ent.[dest_schema_name]		AS [dest_schema_name]
	,ent.[dest_table_name]		AS [dest_table_name]
	,ent.[execution_order]		AS [execution_order]
