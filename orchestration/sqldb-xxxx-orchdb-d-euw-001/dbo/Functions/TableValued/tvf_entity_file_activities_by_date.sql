...
--   entity_file_activities_by_date AS (
--     SELECT
--       entity_id,
--       layer_id,
--       file_name,
...
--           AND
--           efa.trigger_date = @date
--           AND
--           efa.file_name IS NOT NULL
--         THEN
--           efa.required_activities
        
--       skipped_activities
--     FROM
--       entity_activities ea
--     LEFT JOIN
--       vw_full_load_entities AS [full]
--       ON
--         fe.entity_id = ea.entity_id
--     LEFT JOIN
--       entity_file_activities efa
--       ON
--         efa.entity_id = ea.entity_id
--         AND
--         vw_full_load_entities
