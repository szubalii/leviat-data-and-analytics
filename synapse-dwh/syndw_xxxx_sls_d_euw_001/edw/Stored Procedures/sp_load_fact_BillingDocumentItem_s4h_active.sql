...
BEGIN
    ...
    BEGIN TRY
        update [edw].[fact_BillingDocumentItem_s4h_active] 
            ...
            , [ProfitMargin]                          = vwBD.[ProfitMargin]                            
            , [MarginPercent]                         = vwBD.[MarginPercent]                            
            , [FinProfitMargin]                       = vwBD.[FinProfitMargin]                            
            , [FinMarginPercent]                      = vwBD.[FinMarginPercent]                            
...
--            , [axbi_ItemNoCalc]
        ...
        SELECT
            ...
            , vwBD.[ProfitMargin]
            , vwBD.[MarginPercent]
            , vwBD.[FinProfitMargin]
            , vwBD.[FinMarginPercent]
