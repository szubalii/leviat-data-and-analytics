CREATE PROC [edw].[sp_load_fact_SalesDocumentItem_axbi]
  @t_jobId [varchar](36)
, @t_jobDtm [datetime]
...
BEGIN
    ...
    BEGIN TRY
	    IF OBJECT_ID('[edw].[fact_SalesDocumentItem_axbi_tmp]') IS NOT NULL
		    DROP TABLE [edw].[fact_SalesDocumentItem_axbi_tmp];

        CREATE TABLE [edw].[fact_SalesDocumentItem_axbi_tmp]
        WITH
        (
            DISTRIBUTION = HASH ([nk_fact_SalesDocumentItem]),
            CLUSTERED COLUMNSTORE INDEX
        )
        as select * from  [edw].[fact_SalesDocumentItem_axbi] WHERE 1=0;
        ...
        INSERT INTO [edw].[fact_SalesDocumentItem_axbi_tmp] (
        ...
        RENAME OBJECT [edw].[fact_SalesDocumentItem_axbi] TO [fact_SalesDocumentItem_axbi_old];
        RENAME OBJECT [edw].[fact_SalesDocumentItem_axbi_tmp] TO [fact_SalesDocumentItem_axbi];
        DROP TABLE [edw].[fact_SalesDocumentItem_axbi_old];
