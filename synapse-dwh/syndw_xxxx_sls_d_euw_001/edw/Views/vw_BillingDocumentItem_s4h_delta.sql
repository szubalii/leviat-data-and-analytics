...
WITH BillingDocumentItemBase as (
    ...
    BillingDocument_30 AS(
        SELECT 
            ...
            ,   CONVERT(decimal(19,6), [MarginPercent] * ExchangeRateEuro.[ExchangeRate]) as [MarginPercent]
...
SELECT 
    ...
    ,CONVERT(decimal(19,6), [ProfitMargin] * (CASE WHEN [AccountingExchangeRate] < 0 
                                        ...
                                        ELSE [AccountingExchangeRate] 
                                        END)) as [ProfitMargin]
    ,CONVERT(decimal(19,6), [MarginPercent] * (CASE WHEN [AccountingExchangeRate] < 0 
                                        THEN 1 / [AccountingExchangeRate] 
                                        ELSE [AccountingExchangeRate] 
                                        END)) as [MarginPercent]
...
SELECT 
    ...
    ,CONVERT(decimal(19,6), [MarginPercent] * (1/ExchangeRateUSD.[ExchangeRate])) as [MarginPercent]
