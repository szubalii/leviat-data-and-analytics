...
WITH BillingDocumentItemBase as (
    ...
    BillingDocumentItemBase_Margin as (
        SELECT
            ...
            , CASE
                  WHEN BDI_Base.[AccountingExchangeRate] < 0
                  THEN 1 / BDI_Base.[AccountingExchangeRate]
                  ELSE BDI_Base.[AccountingExchangeRate]
              END AS [AccountingExchangeRateForCaculations]
...
SELECT 
    ...
    ,[CustomerTaxClassification9]
    ,[SDPricingProcedure]
    ,CONVERT(decimal(19,6), [NetAmount] * [AccountingExchangeRateForCaculations]) as [NetAmount]
    ,[TransactionCurrencyID]
    ,CONVERT(decimal(19,6), [GrossAmount] * [AccountingExchangeRateForCaculations]) as [GrossAmount]
    ,[PricingDate]
    ,[PriceDetnExchangeRate]
    ,[PricingScaleQuantityInBaseUnit]
    ,CONVERT(decimal(19,6), [TaxAmount] * [AccountingExchangeRateForCaculations]) as [TaxAmount]
    ,CONVERT(decimal(19,6), [CostAmount] * [AccountingExchangeRateForCaculations]) as [CostAmount]
    ,CONVERT(decimal(19,6), [Subtotal1Amount] * [AccountingExchangeRateForCaculations]) as [Subtotal1Amount]
    ,CONVERT(decimal(19,6), [Subtotal2Amount] * [AccountingExchangeRateForCaculations]) as [Subtotal2Amount]
    ,CONVERT(decimal(19,6), [Subtotal3Amount] * [AccountingExchangeRateForCaculations]) as [Subtotal3Amount]
    ,CONVERT(decimal(19,6), [Subtotal4Amount] * [AccountingExchangeRateForCaculations]) as [Subtotal4Amount]
    ,CONVERT(decimal(19,6), [Subtotal5Amount] * [AccountingExchangeRateForCaculations]) as [Subtotal5Amount]
    ,CONVERT(decimal(19,6), [Subtotal6Amount] * [AccountingExchangeRateForCaculations]) as [Subtotal6Amount]
    ,[StatisticalValueControl]
    ,[StatisticsExchangeRate]
    ,[StatisticsCurrency]
    ,[SalesOrganizationCurrency]
    ,CONVERT(decimal(19,6), [EligibleAmountForCashDiscount] * [AccountingExchangeRateForCaculations]) as [EligibleAmountForCashDiscount]
    ,[ContractAccount]
    ,[CustomerPaymentTerms]
    ,[PaymentMethod]
    ,[PaymentReference]
    ...
    ,[SDDocumentReasonID]
    ,[ItemIsRelevantForCredit]
    ,CONVERT(decimal(19,6), [CreditRelatedPrice] * [AccountingExchangeRateForCaculations]) as [CreditRelatedPrice]
    ,[SalesDistrictID]
    ,[CustomerGroupID]
    ,[SoldToParty]
    ,[CountryID]
    ...
    ,[ShippingCondition]
    ,[QuantitySold]
    ,CONVERT(decimal(19,6), [GrossMargin] * [AccountingExchangeRateForCaculations]) as [GrossMargin]
    ,[ExternalSalesAgentID]
    ,[ExternalSalesAgent]
    ,[ProjectID]
    ,[Project]
...
SELECT 
    ...
    ,CR.[CurrencyType]
    ,'USD' AS [CurrencyID]
    ,ExchangeRateUSD.[ExchangeRate] AS [ExchangeRate]
    ,[SalesDocumentItemCategoryID]
    ,[SalesDocumentItemTypeID]
    ,[ReturnItemProcessingType]
    ,[BillingDocumentTypeID]
    ...
    ,[CustomerTaxClassification9]
    ,[SDPricingProcedure]
    ,CONVERT(decimal(19,6), [NetAmount] * ExchangeRateUSD.[ExchangeRate]) as [NetAmount]
    ,[TransactionCurrencyID]
    ,CONVERT(decimal(19,6), [GrossAmount] * ExchangeRateUSD.[ExchangeRate]) as [GrossAmount]
    ,[PricingDate]
    ,[PriceDetnExchangeRate]
    ,[PricingScaleQuantityInBaseUnit]
    ,CONVERT(decimal(19,6), [TaxAmount] * ExchangeRateUSD.[ExchangeRate]) as [TaxAmount]
    ,CONVERT(decimal(19,6), [CostAmount] * ExchangeRateUSD.[ExchangeRate]) as [CostAmount]
    ,CONVERT(decimal(19,6), [Subtotal1Amount] * ExchangeRateUSD.[ExchangeRate]) as [Subtotal1Amount]
    ,CONVERT(decimal(19,6), [Subtotal2Amount] * ExchangeRateUSD.[ExchangeRate]) as [Subtotal2Amount]
    ,CONVERT(decimal(19,6), [Subtotal3Amount] * ExchangeRateUSD.[ExchangeRate]) as [Subtotal3Amount]
    ,CONVERT(decimal(19,6), [Subtotal4Amount] * ExchangeRateUSD.[ExchangeRate]) as [Subtotal4Amount]
    ,CONVERT(decimal(19,6), [Subtotal5Amount] * ExchangeRateUSD.[ExchangeRate]) as [Subtotal5Amount]
    ,CONVERT(decimal(19,6), [Subtotal6Amount] * ExchangeRateUSD.[ExchangeRate]) as [Subtotal6Amount]
    ,[StatisticalValueControl]
    ,[StatisticsExchangeRate]
    ,[StatisticsCurrency]
    ,[SalesOrganizationCurrency]
    ,CONVERT(decimal(19,6), [EligibleAmountForCashDiscount] * ExchangeRateUSD.[ExchangeRate]) as [EligibleAmountForCashDiscount]
    ,[ContractAccount]
    ,[CustomerPaymentTerms]
    ,[PaymentMethod]
    ,[PaymentReference]
    ...
    ,[SDDocumentReasonID]
    ,[ItemIsRelevantForCredit]
    ,CONVERT(decimal(19,6), [CreditRelatedPrice] * ExchangeRateUSD.[ExchangeRate]) as [CreditRelatedPrice]
    ,[SalesDistrictID]
    ,[CustomerGroupID]
    ,[SoldToParty]
    ,[CountryID]
    ...
    ,[ShippingCondition]
    ,[QuantitySold]
    ,CONVERT(decimal(19,6), [GrossMargin] * ExchangeRateUSD.[ExchangeRate]) as [GrossMargin]
    ,[ExternalSalesAgentID]
    ,[ExternalSalesAgent]
    ,[ProjectID]
    ,[Project]
