...
WITH BillingDocumentItemBase as (
    ...
    from [base_s4h_cax].[C_BillingDocumentItemBasicDEX] doc
        ...
        left join [base_s4h_cax].[C_BillingDocumentPartnerFs] RE
...
SELECT 
    ...
    ,[TransactionCurrencyID]
    ,CONVERT(decimal(19,6), [GrossAmount] * EuroBudgetExchangeRate.[ExchangeRate]) as [GrossAmount]
    ,[PricingDate]
    ,[PriceDetnExchangeRate]
    ,[PricingScaleQuantityInBaseUnit]
    ...
    ,[StatisticsCurrency]
    ,[SalesOrganizationCurrency]
    ,CONVERT(decimal(19,6), [EligibleAmountForCashDiscount] * EuroBudgetExchangeRate.[ExchangeRate]) as [EligibleAmountForCashDiscount]
    ,[ContractAccount]
    ,[CustomerPaymentTerms]
    ,[PaymentMethod]
    ,[PaymentReference]
    ...
    ,[SDDocumentReasonID]
    ,[ItemIsRelevantForCredit]
    ,CONVERT(decimal(19,6), [CreditRelatedPrice] * EuroBudgetExchangeRate.[ExchangeRate]) as [CreditRelatedPrice]
    ,[SalesDistrictID]
    ,[CustomerGroupID]
    ,[SoldToParty]
    ,[CountryID]
    ...
    ,[ShippingCondition]
    ,[QuantitySold]
    ,CONVERT(decimal(19,6), [GrossMargin] * EuroBudgetExchangeRate.[ExchangeRate]) as [GrossMargin]
    ,[ExternalSalesAgentID]
    ,[ExternalSalesAgent]
    ,[ProjectID]
    ,[Project]
    ...
    ,[SoldToPartyCalculated]
    ,[InOutID]
    ,bdi_er_date.[t_applicationId]
    ,bdi_er_date.[t_extractionDtm]
    --,bdi_er_date.[t_jobId]
...
LEFT JOIN 
    EuroBudgetExchangeRate
    ON
        bdi_er_date.[TransactionCurrencyID] = EuroBudgetExchangeRate.[SourceCurrency]
        AND
        bdi_er_date.[ExchangeRateEffectiveDate] = EuroBudgetExchangeRate.[ExchangeRateEffectiveDate]
CROSS JOIN 
    [edw].[dim_CurrencyType] CR
WHERE 
