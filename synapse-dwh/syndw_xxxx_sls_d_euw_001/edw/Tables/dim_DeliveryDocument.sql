...
(
    [DeliveryDocumentID]             nvarchar(10) NOT NULL,
    ...
    CONSTRAINT [PK_dim_DeliveryDocument] PRIMARY KEY NONCLUSTERED ([DeliveryDocumentID]) NOT ENFORCED
)WITH
