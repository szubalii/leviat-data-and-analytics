...
(
    ...
    [BillingQuantityUnitID]                 NVARCHAR(6)                                  NULL,
    [BillingQuantityInBaseUnit]             DECIMAL(13, 3)                               NULL,
    [BaseUnit]                              NVARCHAR(6)                                  NULL,
    ...
    [ItemWeightUnit]                        NVARCHAR(6)                                  NULL,
    [ItemVolume]                            DECIMAL(15, 3)                               NULL,
    [ItemVolumeUnit]                        NVARCHAR(6)                                  NULL,
    ...
    [TransactionCurrencyID]                 CHAR(5)                                      NULL,
    ...
    [StatisticsCurrency]                    CHAR(5)                                      NULL,
    [SalesOrganizationCurrency]             CHAR(5)                                      NULL,
