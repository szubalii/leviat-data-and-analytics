...
(
    ...
    [PurchasingDocumentCategory]   nvarchar(1) NOT NULL,
    ...
    CONSTRAINT [PK_dim_PurchasingDocumentType] PRIMARY KEY NONCLUSTERED ([PurchasingDocumentTypeID], [PurchasingDocumentCategory]) NOT ENFORCED
)
WITH
