CREATE TABLE [edw].[dim_OutboundDeliveryItem] (
...
, [DeliveryItemResourceID] nvarchar(80)
...
, [WarehouseStagingArea] nvarchar(20)
...
, [SubsequentMovementType] nvarchar(6)
...
, [LoadingPointForDelivery] nvarchar(40)
...
, [SalesSDDocumentCategory] nvarchar(8)
, [MaterialTypePrimary] nvarchar(8)
...
, [OrderDocument] nvarchar(20)
, [PlanningMaterial] nvarchar(80)
, [PlanningPlant] nvarchar(8)
, [ProductGroupBaseUnit] nvarchar(6) -- collate Latin1_General_100_BIN2
, [ConversionFactor] float
, [IsReturnsItem] nvarchar(2)
, [ConditionUnit] nvarchar(6) -- collate Latin1_General_100_BIN2
, [NetPriceAmount] decimal(11,2)
, [TotalNetAmount] decimal(15,2)
, [QtyInPurchaseOrderPriceUnit] decimal(13,3)
, [CreditRelatedPrice] float
, [CreditRelatedPriceAmount] decimal(11,2)
...
, [EU_DeliveryItemARCStatus] nvarchar(2)
, [t_applicationId]       VARCHAR (32)
, [t_jobId]               VARCHAR (36)
, [t_jobDtm]              DATETIME
, [t_lastActionCd]        VARCHAR(1)
, [t_jobBy]               NVARCHAR(128)
,    CONSTRAINT [PK_dim_OutboundDeliveryItem] PRIMARY KEY NONCLUSTERED ([OutboundDelivery],[OutboundDeliveryItem]) NOT ENFORCED
)
WITH
(
