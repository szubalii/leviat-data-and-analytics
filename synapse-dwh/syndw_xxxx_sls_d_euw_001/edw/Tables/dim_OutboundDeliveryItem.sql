...
, [OutboundDeliveryItem] char(6) NOT NULL
...
, [HigherLvlItmOfBatSpltItm] char(6) 
...
, [DeliveryGroup] char(3) 
, [ItemGrossWeight] decimal(15,3)
, [ItemNetWeight] decimal(15,3)
, [ItemWeightUnit] nvarchar(6) 
, [ItemVolume] decimal(15,3)
, [ItemVolumeUnit] nvarchar(6) 
, [InspectionLot] char(12) 
, [InspectionPartialLot] char(6) 
...
, [GoodsMovementReasonCode] char(4) 
...
, [ReferenceSDDocumentItem] char(6) 
...
, [ProductGroupBaseUnit] nvarchar(6) 
, [ConversionFactor] float
, [IsReturnsItem] nvarchar(2)
, [ConditionUnit] nvarchar(6) 
