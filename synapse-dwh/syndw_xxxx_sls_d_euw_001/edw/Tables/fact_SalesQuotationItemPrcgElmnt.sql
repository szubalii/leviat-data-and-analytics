...
(
  ...
  , [t_jobBy]               NVARCHAR(128)  
    CONSTRAINT [PK_fact_SalesQuotationItemPrcgElmnt] PRIMARY KEY NONCLUSTERED ([SalesQuotation], [SalesQuotationItem],[PricingProcedureStep],[PricingProcedureCounter], [CurrencyTypeID]) NOT ENFORCED
)
WITH
(
