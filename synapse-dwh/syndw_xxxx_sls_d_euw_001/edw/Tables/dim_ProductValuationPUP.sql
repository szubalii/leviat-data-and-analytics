...
(   
    ...
    [FiscalYearPeriod]               CHAR(4) COLLATE Latin1_General_100_BIN2      NOT NULL,
    [FiscalMonthPeriod]              CHAR(2) COLLATE Latin1_General_100_BIN2      NOT NULL,
    ...
    [StockPricePerUnit]              DECIMAL(13, 6),
    [StockPricePerUnit_EUR]          DECIMAL(13, 6),
