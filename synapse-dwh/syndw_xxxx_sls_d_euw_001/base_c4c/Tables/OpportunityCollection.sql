...
(
    ...
    /*[ProcessingTypeCodeText]                        VARCHAR(?)          NULL,
    [ID]                                            NVARCHAR(35)        NULL,
    ...
    [PhaseProgressEvaluationStatusCodeText]         CHAR(?)             NULL,
    [ProspectBudgetAmount]                          DECIMAL(28, 6)      NULL,
    [ProspectBudgetAmountCurrencyCode]              CHAR(3)             NULL,
    [ProspectBudgetAmountCurrencyCodeText]          CHAR(?)             NULL,
    [Score]                                         INT???              NULL,
    ...
    [ConsistencyStatusCodeText]                     CHAR(?)             NULL,
    [ApprovalStatusCode]                            CHAR(2)             NULL,
    [ApprovalStatusCodeText]                        CHAR(?)             NULL,
    ...
    [Zclassification_KUTText]                       CHAR(?)             NULL,
    [Zexpectedorderdate_KUT]                        DATETIME            NULL,
    [Zframe_KUT]                                    CHAR(30)            NULL,
    [Zframe_KUTText]                                CHAR(?)             NULL,
    [Zinterproject_KUT]                             BOOLEAN             NULL,
    ...
    [Zprojectcountry_KUTText]                       VARCHAR(??)         NULL,
    [Zprojectdescription_KUT]                       VARCHAR(??)         NULL,
    [Zprojectpostalcode_KUT]                        VARCHAR(40)         NULL,
    [Zprojectstreet_KUT]                            VARCHAR(80)         NULL,
    [Zprojecttype1_KUT]                             VARCHAR(30)         NULL,
    [Zprojecttype1_KUTText]                         VARCHAR(??)         NULL,
    [Zprojecttype2_KUT]                             VARCHAR(30)         NULL,
    [Zprojecttype2_KUTText]                         VARCHAR(??)         NULL,
    ...
    CONSTRAINT [PK_OpprotunityCollection] PRIMARY KEY NONCLUSTERED (
        [ObjectID],
        [ProspectPartyID],
        [Name],
