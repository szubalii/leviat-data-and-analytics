...
(
    ...
    [FirstEmailReceivedOn]                          DATETIME            NULL,
    [FirstEmailSentOn]                              DATETIME            NULL,
    [LastDataHugSyncDateTime]                       DATETIME            NULL,
    [LastEmailReceivedFrom]                         VARCHAR(255)        NULL,
    [LastEmailReceivedOn]                           DATETIME            NULL,
    [LastEmailSentBy]                               VARCHAR(255)        NULL,
    [LastEmailSentOn]                               DATETIME            NULL,
    [LastMeetingOn]                                 DATETIME            NULL,
    [NextMeetingOn]                                 DATETIME            NULL,
