...
(
    ...
    [HeaderRevenueSchedule]                         VARCHAR(5)          NULL,
    [SalesRevenueForecastRelevanceIndicator]        VARCHAR(5)          NULL,
    ...
    [AutoCreateContacts]                            VARCHAR(5)          NULL,
    [HugRank]                                       INT                 NULL,
    ...
    [Zinterproject_KUT]                             VARCHAR(5)          NULL,
