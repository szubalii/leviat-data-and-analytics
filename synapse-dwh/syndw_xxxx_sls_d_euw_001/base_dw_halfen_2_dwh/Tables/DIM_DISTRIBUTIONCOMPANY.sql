CREATE TABLE [base_dw_halfen_2_dwh].[DIM_DISTRIBUTIONCOMPANY] (
    ...
    [Distributioncompany]                     NVARCHAR (10)   NULL,
    [Distributioncompanydescription]         NCHAR (40)      NULL,
    [Distributioncompanydistcmp_description] VARCHAR (500)   NULL,
    [SalesArea]                               VARCHAR (3)     NULL,
    ...
    [Salesareadescription]                   NVARCHAR (60)   NULL,
    [Salesareasalesarea_description]         VARCHAR (500)   NULL,
