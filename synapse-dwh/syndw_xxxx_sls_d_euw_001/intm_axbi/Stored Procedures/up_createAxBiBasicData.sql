...
--old logic commented by Erich
	...
	update [intm_axbi].[dim_CUSTTABLE]
	set INOUT = 'I'
	 where UPPER(DATAAREAID) in ('PLBE', 'PLFR') and  substring(NAME, 1, 5) = 'Ancon'

	update [intm_axbi].[dim_CUSTTABLE]
	set INOUT = 'I'
	 where UPPER(DATAAREAID) in ('PLBE', 'PLFR') and  substring(NAME, 1, 5) = 'Plaka'

	update [intm_axbi].[dim_CUSTTABLE]
	set INOUT = 'I'
	 where UPPER(DATAAREAID) in ('PLBE', 'PLFR') and  substring(NAME, 1, 6) = 'Halfen'

	update [intm_axbi].[dim_CUSTTABLE]
	set INOUT = 'I'
	 where UPPER(DATAAREAID) in ('PLBE', 'PLFR') and  NAME like '%Aschwanden%'

	update [intm_axbi].[dim_CUSTTABLE]
	set INOUT = 'I'
	 where UPPER(DATAAREAID) in ('PLBE', 'PLFR') and  NAME like '%Helifix (Australia)%'
...
*/
	...
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-A.1.', 'BRICKWORK SUPPORT', 'A.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-A.2.', 'WALL TIES & FIXINGS', 'A.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-A.3.', 'MURFOR', 'A.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-A.4.', 'HELIFIX', 'A.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-B.1.', 'NATURAL STONE FIXING', 'B.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-B.2.', 'CONCRETE FACADE SYSTEMS', 'B.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-B.3.', 'CURTAIN WALL SYSTEM', 'B.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-B.4.', 'OTHER FACADE PRODUCTS', 'B.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-C.1.', 'CONCRETE : WET CAST', 'C.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-C.2.', 'CONCRETE : FIBERS + EXTRUDED', 'C.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-C.3.', 'PLASTIC', 'C.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-C.4.', 'STEEL', 'C.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-D.1.', 'BALCONY INSULATION', 'D.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-D.2.', 'ACOUSTIC PANELS & FORMS', 'D.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-D.3.', 'ACOUSTIC COMPONENTS', 'D.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.1.', 'REBEND REINFORCEMENT', 'E.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.2.', 'REBAR COUPLERS + CONNECTORS', 'E.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.3.', 'INVISIBLE CONNECTION', 'E.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.4.', 'PUNCHING SHEAR', 'E.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.5.', 'STEEL REINFORCEMENT', 'E.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.6.', 'SYNTHETIC REINFORCEMENT', 'E.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.7.', 'SHEAR LOAD CONNECTOR', 'E.7.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.8.', 'COLUMN SHOE', 'E.8.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-E.9.', 'POST TENSION', 'E.9.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-F.1.', 'SINGLE-USE FORMWORK', 'F.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-F.2.', 'RE-USABLE FORMWORK', 'F.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-F.3.', 'TUBULAR COLUMNS', 'F.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-F.4.', 'MAGNETS', 'F.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-F.5.', 'OTHER FORMWORK ACC. (DYWIDAG; PLASTIC PROFILES)', 'F.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-G.1.', 'DILATATION JOINTS', 'G.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-G.2.', 'JOINT COVER & SEPARATION', 'G.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-H.1.', 'LOOPING DEVICES', 'H.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-H.2.', 'SPHERICAL HEAD ANCHORS', 'H.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-H.3.', 'FLAT STEEL ANCHORS', 'H.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-H.4.', 'THREADED SYSTEMS', 'H.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-H.5.', 'CHAINS AND CABLES', 'H.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-H.6.', 'OTHER LIFTING SYSTEMS', 'H.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-I.1.', 'CAST IN CHANNELS', 'I.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-I.2.', 'ANCHORING ACCESSORIES', 'I.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-I.3.', 'BOLTS', 'I.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-I.4.', 'INSERTS', 'I.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-I.5.', 'CHEMICAL ANCHORING', 'I.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-I.6.', 'FRAMING', 'I.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-I.7.', 'OTHER FIXING', 'I.7.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-J.1.', 'BUILDING & CONSTRUCTION BEARINGS', 'J.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-J.2.', 'CIVIL ENGINEERING BEARINGS', 'J.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-K.1.', 'WATERSTOP + INJECTION SYSTEM', 'K.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-K.2.', 'STRIPS & PROFILES', 'K.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-K.3.', 'OTHERS', 'K.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-L.1.', 'MORTARS & PASTES', 'L.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-L.2.', 'DEMOULDING AGENTS', 'L.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-L.3.', 'ADMIXTURES & GROUTS', 'L.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-L.4.', 'OTHER CHEMICAL PRODUCTS', 'L.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-M.1.', 'SITE EQUIPMENT', 'M.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-N.1.', 'TENSION ROD SYSTEMS', 'N.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-N.2.', 'HEAVY LOAD SYSTEMS', 'N.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-N.3.', 'OTHERS', 'N.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-O.1.', 'CONSTRUCTION FOILS', 'O.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-O.2.', 'DRAINAGE FOILS', 'O.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAU', 'ANAU-O.3.', 'VAPOUR BARRIER FOILS + OTHERS', 'O.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)

	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-A.1.', 'BRICKWORK SUPPORT', 'A.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-A.2.', 'WALL TIES & FIXINGS', 'A.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-A.3.', 'MURFOR', 'A.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-A.4.', 'HELIFIX', 'A.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-B.1.', 'NATURAL STONE FIXING', 'B.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-B.2.', 'CONCRETE FACADE SYSTEMS', 'B.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-B.3.', 'CURTAIN WALL SYSTEM', 'B.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-B.4.', 'OTHER FACADE PRODUCTS', 'B.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-C.1.', 'CONCRETE : WET CAST', 'C.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-C.2.', 'CONCRETE : FIBERS + EXTRUDED', 'C.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-C.3.', 'PLASTIC', 'C.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-C.4.', 'STEEL', 'C.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-D.1.', 'BALCONY INSULATION', 'D.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-D.2.', 'ACOUSTIC PANELS & FORMS', 'D.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-D.3.', 'ACOUSTIC COMPONENTS', 'D.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.1.', 'REBEND REINFORCEMENT', 'E.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.2.', 'REBAR COUPLERS + CONNECTORS', 'E.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.3.', 'INVISIBLE CONNECTION', 'E.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.4.', 'PUNCHING SHEAR', 'E.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.5.', 'STEEL REINFORCEMENT', 'E.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.6.', 'SYNTHETIC REINFORCEMENT', 'E.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.7.', 'SHEAR LOAD CONNECTOR', 'E.7.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.8.', 'COLUMN SHOE', 'E.8.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-E.9.', 'POST TENSION', 'E.9.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-F.1.', 'SINGLE-USE FORMWORK', 'F.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-F.2.', 'RE-USABLE FORMWORK', 'F.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-F.3.', 'TUBULAR COLUMNS', 'F.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-F.4.', 'MAGNETS', 'F.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-F.5.', 'OTHER FORMWORK ACC. (DYWIDAG; PLASTIC PROFILES)', 'F.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-G.1.', 'DILATATION JOINTS', 'G.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-G.2.', 'JOINT COVER & SEPARATION', 'G.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-H.1.', 'LOOPING DEVICES', 'H.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-H.2.', 'SPHERICAL HEAD ANCHORS', 'H.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-H.3.', 'FLAT STEEL ANCHORS', 'H.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-H.4.', 'THREADED SYSTEMS', 'H.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-H.5.', 'CHAINS AND CABLES', 'H.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-H.6.', 'OTHER LIFTING SYSTEMS', 'H.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-I.1.', 'CAST IN CHANNELS', 'I.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-I.2.', 'ANCHORING ACCESSORIES', 'I.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-I.3.', 'BOLTS', 'I.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-I.4.', 'INSERTS', 'I.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-I.5.', 'CHEMICAL ANCHORING', 'I.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-I.6.', 'FRAMING', 'I.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-I.7.', 'OTHER FIXING', 'I.7.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-J.1.', 'BUILDING & CONSTRUCTION BEARINGS', 'J.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-J.2.', 'CIVIL ENGINEERING BEARINGS', 'J.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-K.1.', 'WATERSTOP + INJECTION SYSTEM', 'K.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-K.2.', 'STRIPS & PROFILES', 'K.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-K.3.', 'OTHERS', 'K.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-L.1.', 'MORTARS & PASTES', 'L.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-L.2.', 'DEMOULDING AGENTS', 'L.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-L.3.', 'ADMIXTURES & GROUTS', 'L.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-L.4.', 'OTHER CHEMICAL PRODUCTS', 'L.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-M.1.', 'SITE EQUIPMENT', 'M.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-N.1.', 'TENSION ROD SYSTEMS', 'N.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-N.2.', 'HEAVY LOAD SYSTEMS', 'N.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-N.3.', 'OTHERS', 'N.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-O.1.', 'CONSTRUCTION FOILS', 'O.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-O.2.', 'DRAINAGE FOILS', 'O.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANAH', 'ANAH-O.3.', 'VAPOUR BARRIER FOILS + OTHERS', 'O.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)

	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-A.1.', 'BRICKWORK SUPPORT', 'A.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-A.2.', 'WALL TIES & FIXINGS', 'A.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-A.3.', 'MURFOR', 'A.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-A.4.', 'HELIFIX', 'A.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-B.1.', 'NATURAL STONE FIXING', 'B.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-B.2.', 'CONCRETE FACADE SYSTEMS', 'B.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-B.3.', 'CURTAIN WALL SYSTEM', 'B.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-B.4.', 'OTHER FACADE PRODUCTS', 'B.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-C.1.', 'CONCRETE : WET CAST', 'C.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-C.2.', 'CONCRETE : FIBERS + EXTRUDED', 'C.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-C.3.', 'PLASTIC', 'C.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-C.4.', 'STEEL', 'C.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-D.1.', 'BALCONY INSULATION', 'D.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-D.2.', 'ACOUSTIC PANELS & FORMS', 'D.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-D.3.', 'ACOUSTIC COMPONENTS', 'D.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.1.', 'REBEND REINFORCEMENT', 'E.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.2.', 'REBAR COUPLERS + CONNECTORS', 'E.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.3.', 'INVISIBLE CONNECTION', 'E.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.4.', 'PUNCHING SHEAR', 'E.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.5.', 'STEEL REINFORCEMENT', 'E.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.6.', 'SYNTHETIC REINFORCEMENT', 'E.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.7.', 'SHEAR LOAD CONNECTOR', 'E.7.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.8.', 'COLUMN SHOE', 'E.8.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-E.9.', 'POST TENSION', 'E.9.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-F.1.', 'SINGLE-USE FORMWORK', 'F.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-F.2.', 'RE-USABLE FORMWORK', 'F.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-F.3.', 'TUBULAR COLUMNS', 'F.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-F.4.', 'MAGNETS', 'F.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-F.5.', 'OTHER FORMWORK ACC. (DYWIDAG; PLASTIC PROFILES)', 'F.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-G.1.', 'DILATATION JOINTS', 'G.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-G.2.', 'JOINT COVER & SEPARATION', 'G.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-H.1.', 'LOOPING DEVICES', 'H.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-H.2.', 'SPHERICAL HEAD ANCHORS', 'H.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-H.3.', 'FLAT STEEL ANCHORS', 'H.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-H.4.', 'THREADED SYSTEMS', 'H.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-H.5.', 'CHAINS AND CABLES', 'H.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-H.6.', 'OTHER LIFTING SYSTEMS', 'H.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-I.1.', 'CAST IN CHANNELS', 'I.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-I.2.', 'ANCHORING ACCESSORIES', 'I.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-I.3.', 'BOLTS', 'I.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-I.4.', 'INSERTS', 'I.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-I.5.', 'CHEMICAL ANCHORING', 'I.5.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-I.6.', 'FRAMING', 'I.6.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-I.7.', 'OTHER FIXING', 'I.7.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-J.1.', 'BUILDING & CONSTRUCTION BEARINGS', 'J.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-J.2.', 'CIVIL ENGINEERING BEARINGS', 'J.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-K.1.', 'WATERSTOP + INJECTION SYSTEM', 'K.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-K.2.', 'STRIPS & PROFILES', 'K.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-K.3.', 'OTHERS', 'K.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-L.1.', 'MORTARS & PASTES', 'L.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-L.2.', 'DEMOULDING AGENTS', 'L.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-L.3.', 'ADMIXTURES & GROUTS', 'L.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-L.4.', 'OTHER CHEMICAL PRODUCTS', 'L.4.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-M.1.', 'SITE EQUIPMENT', 'M.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-N.1.', 'TENSION ROD SYSTEMS', 'N.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-N.2.', 'HEAVY LOAD SYSTEMS', 'N.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-N.3.', 'OTHERS', 'N.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-O.1.', 'CONSTRUCTION FOILS', 'O.1.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-O.2.', 'DRAINAGE FOILS', 'O.2.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
	insert into [intm_axbi].[dim_ITEMTABLE] (DATAAREAID,ITEMID,ITEMNAME,PRODUCTGROUPID,ITEMGROUPID) VALUES('ANNZ', 'ANNZ-O.3.', 'VAPOUR BARRIER FOILS + OTHERS', 'O.3.', ' ',@t_applicationId_ANCON_AUSTRALIA,@t_jobId,@t_jobDtm,@t_jobBy,NULL)
