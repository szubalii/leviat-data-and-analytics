CREATE TABLE [base_s4h_cax].[I_SupplierInvoiceItemPurOrdRef]
...
(
    ...
    [SupplierInvoiceItem]            char(6) collate Latin1_General_100_BIN2      NOT NULL,
    ...
    CONSTRAINT [PK_I_SupplierInvoiceItemPurOrdRef] PRIMARY KEY NONCLUSTERED ([MANDT], [SupplierInvoice], [FiscalYear], [SupplierInvoiceItem]) NOT ENFORCED
)
WITH (HEAP)
