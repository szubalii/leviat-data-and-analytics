CREATE TABLE [base_s4h_cax].[I_SalesOrderPricingElement](
...
, CONSTRAINT [PK_I_SalesOrderPricingElement] PRIMARY KEY NONCLUSTERED (
    [MANDT], [SalesOrder], [PricingProcedureStep], [PricingProcedureCounter]
  ) NOT ENFORCED
)
WITH (
  HEAP
