CREATE TABLE [base_s4h_cax].[I_BillingDocumentPrcgElmnt](
...
, CONSTRAINT [PK_I_BillingDocumentPrcgElmnt] PRIMARY KEY NONCLUSTERED (
    [MANDT], [BillingDocument], [PricingProcedureStep], [PricingProcedureCounter]
  ) NOT ENFORCED
)
WITH (
  HEAP
