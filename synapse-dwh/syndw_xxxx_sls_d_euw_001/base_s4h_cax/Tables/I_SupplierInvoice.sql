...
(
    ...
    [ReverseDocument]                nvarchar(10), -- collate Latin1_General_100_BIN2,
    [ReverseDocumentFiscalYear]      char(4), -- collate Latin1_General_100_BIN2,
    ...
    CONSTRAINT [PK_I_SupplierInvoice] PRIMARY KEY NONCLUSTERED ([MANDT], [SupplierInvoice], [FiscalYear]) NOT ENFORCED
)
WITH (HEAP)
