CREATE TABLE [base_s4h_cax].[I_GLAccountLineItemRawData_202406](
    ...
    [ReferenceDocumentItemGroup]     char(6), 
    ...
    [SourceReferenceDocSubitem]      char(6), 
    ...
    [SubLedgerAcctLineItemType]      char(5), 
    ...
    [ReferencePurchaseOrderCategory] char(3), 
    ...
    [ControllingObjectDebitType]     char(1), 
    [QuantityIsIncomplete]           char(1), 
    ...
    [PartnerServiceDocumentItem]     char(6), 
    [ServiceContractType]            nvarchar(4),
    [ServiceContract]                nvarchar(10),
    [ServiceContractItem]            char(6), 
    ...
    [PartnerOrderCategory]           char(2), 
    [PartnerSalesDocument]           nvarchar(10),
    [PartnerSalesDocumentItem]       char(6), 
    ...
    [PubSecBudgetCnsmpnFsclPeriod]   char(3), 
    [PubSecBudgetCnsmpnFsclYear]     char(4), 
    ...
    [t_filePath]                     NVARCHAR(1024),
     CONSTRAINT [PK_I_GLAccountLineItemRawData_202406] PRIMARY KEY NONCLUSTERED (
