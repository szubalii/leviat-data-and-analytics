CREATE TABLE [base_s4h_cax].[C_BillingDocumentItemBasicDEX_active]
(
    ...
    CONSTRAINT [PK_C_BillingDocumentItemBasicDEX_active] PRIMARY KEY NONCLUSTERED (
       [MANDT], [BillingDocument],
       [BillingDocumentItem]
    ) NOT ENFORCED
)
    WITH ( DISTRIBUTION = HASH (BillingDocument), CLUSTERED COLUMNSTORE INDEX )
