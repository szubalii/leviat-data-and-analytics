...
, [t_filePath]            NVARCHAR (1024)
    CONSTRAINT [PK_I_FinancialInstrTransTypeText_Language_FinancialInstrumentProductType_FinancialInstrTransactionType] PRIMARY KEY NONCLUSTERED ([Language],[FinancialInstrumentProductType],[FinancialInstrTransactionType]) NOT ENFORCED
)
WITH
(
