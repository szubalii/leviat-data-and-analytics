CREATE TABLE [base_s4h_cax].[C_BillingDocumentItemBasicDEX_delta]
(
    ...
    CONSTRAINT [PK_C_BillingDocumentItemBasicDEX_delta] PRIMARY KEY NONCLUSTERED (
          [TS_SEQUENCE_NUMBER], [MANDT],
          [BillingDocument],
          [BillingDocumentItem]
    ) NOT ENFORCED
)
