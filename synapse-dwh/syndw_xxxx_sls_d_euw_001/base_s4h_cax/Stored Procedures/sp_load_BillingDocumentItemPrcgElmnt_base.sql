CREATE PROC [base_s4h_uat_caa].[sp_load_BillingDocumentItemPrcgElmnt_base]
...
BEGIN
	...
	TRUNCATE TABLE [base_s4h_uat_caa].[I_BillingDocumentItemPrcgElmnt]

	INSERT INTO [base_s4h_uat_caa].[I_BillingDocumentItemPrcgElmnt](
		[BillingDocument]
		,[BillingDocumentItem]
	...
	FROM [base_s4h_uat_caa].[I_BillingDocumentItemPrcgElmnt_staging]
END
