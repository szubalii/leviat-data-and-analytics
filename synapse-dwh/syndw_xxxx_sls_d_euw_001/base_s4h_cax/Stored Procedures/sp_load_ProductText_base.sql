CREATE PROC [base_s4h_uat_caa].[sp_load_ProductText_base]
...
BEGIN
	...
	TRUNCATE TABLE [base_s4h_uat_caa].[I_ProductText]

	INSERT INTO [base_s4h_uat_caa].[I_ProductText](
		[Product]
		,[Language]
		,[ProductName]
		,[t_applicationId]
	...
	FROM [base_s4h_uat_caa].[I_ProductText_staging]
END
