CREATE PROC [base_s4h_uat_caa].[sp_load_PostingKeyText_base] 
...
BEGIN
	...
	TRUNCATE TABLE [base_s4h_uat_caa].[I_PostingKeyText]

	INSERT INTO [base_s4h_uat_caa].[I_PostingKeyText](
	   [Language]
      ,[PostingKey]
      ,[PostingKeyName]
      ,[t_applicationId]
	...
	FROM [base_s4h_uat_caa].[I_PostingKeyText_staging]
END