CREATE PROC [base_s4h_uat_caa].[sp_load_ProfitCenterText_base] 
...
BEGIN
	...
	TRUNCATE TABLE [base_s4h_uat_caa].[I_ProfitCenterText]

	INSERT INTO [base_s4h_uat_caa].[I_ProfitCenterText](
	   [Language]
      ,[ControllingArea]
      ,[ProfitCenter]
      ,[ValidityEndDate]
	...
	FROM [base_s4h_uat_caa].[I_ProfitCenterText_staging]
END