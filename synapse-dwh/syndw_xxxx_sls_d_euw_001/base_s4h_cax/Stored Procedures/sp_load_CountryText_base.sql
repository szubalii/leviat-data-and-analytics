CREATE PROC [base_s4h_uat_caa].[sp_load_CountryText_base]
...
BEGIN
	...
	TRUNCATE TABLE [base_s4h_uat_caa].[I_CountryText]

	INSERT INTO [base_s4h_uat_caa].[I_CountryText](
		[Country]
		,[Language]
		,[CountryName]
		,[NationalityName]
	...
	FROM [base_s4h_uat_caa].[I_CountryText_staging]
END
