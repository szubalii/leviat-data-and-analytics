...
,   CAST(docBilling.[BillingQuantity]  AS decimal (20,2)) as [BillingQuantity]  
--,   docBilling.[UnitOfMeasureID]        AS [BillingQuantityUnitID]
--,   docBilling.[UnitOfMeasure]          AS [BillingQuantityUnit]
,   CAST (docBilling.[NetAmount] AS decimal (20,2)) as [NetAmount] 
,   docBilling.[TransactionCurrencyID]
,   CAST (docBilling.[GrossAmount] AS decimal (20,2)) as [GrossAmount] 
,   CAST (docBilling.[TaxAmount] AS decimal (20,2)) as [TaxAmount] 
,   CAST (docBilling.[CostAmount] AS decimal (20,2)) as [CostAmount] 
,   CAST (docBilling.[ProfitMargin] AS decimal (20,2)) as [QuantitySold] 
,   CAST (docBilling.[MarginPercent] AS decimal (20,2)) as [MarginPercent] 
,   CAST (docBilling.[FinProfitMargin] AS decimal (20,2)) as [FinProfitMargin] 
,   CAST (docBilling.[FinMarginPercent] AS decimal (20,2)) as [FinMarginPercent] 
...
,   CAST (docBilling.[QuantitySold] AS decimal (20,2)) as [QuantitySold] 
,   CAST (docBilling.[GrossMargin] AS decimal (20,2)) as [GrossMargin] 
...
,   CAST (docBilling.[FinNetAmountRealProduct] AS decimal (20,2)) as [FinNetAmountRealProduct] 
,   CAST (docBilling.[FinNetAmountFreight] AS decimal (20,2)) as [FinNetAmountFreight] 
,   CAST (docBilling.[FinNetAmountMinQty] AS decimal (20,2))as [FinNetAmountMinQty] 
,   CAST (docBilling.[FinNetAmountEngServ] AS decimal (20,2)) as [FinNetAmountEngServ] 
,   CAST (docBilling.[FinNetAmountMisc] AS decimal (20,2)) as [FinNetAmountMisc] 
,   CAST (docBilling.[FinNetAmountServOther] AS decimal (20,2)) as [FinNetAmountServOther] 
,   CAST (docBilling.[FinNetAmountVerp] AS decimal (20,2)) as [FinNetAmountVerp] 
,   CAST (docBilling.[FinRebateAccrual] AS decimal (20,2)) as [FinRebateAccrual] 
,   CAST (docBilling.[FinReserveCashDiscount] AS decimal (20,2)) as [FinReserveCashDiscount] 
,   CAST (docBilling.[FinSales100] AS decimal (20,2)) as [FinSales100] 
,   CAST (docBilling.[FinNetAmountOtherSales] AS decimal (20,2)) as [FinNetAmountOtherSales] 
,   CAST (docBilling.[FinNetAmountAllowances] AS decimal (20,2)) as [FinNetAmountAllowances] 
...
--,   docBilling.[UnitOfMeasureID]        AS [BillingQuantityUnitID]
--,   docBilling.[UnitOfMeasure]          AS [BillingQuantityUnit]
,   CAST (docBillingUS.[NetAmount] AS decimal (20,2)) as [NetAmount] 
,   docBillingUS.[TransactionCurrencyID]
,   NULL AS [GrossAmount]
,   CAST (docBillingUS.[TaxAmount] AS decimal (20,2)) as [TaxAmount] 
,   CAST (docBillingUS.[CostAmount] AS decimal (20,2)) as [CostAmount] 
,   CAST (docBillingUS.[ProfitMargin] AS decimal (20,2)) as [ProfitMargin] 
,   CAST (docBillingUS.[MarginPercent] AS decimal (20,2)) as [MarginPercent] 
,   CAST (docBillingUS.[FinProfitMargin] AS decimal (20,2)) as [FinProfitMargin] 
,   CAST (docBillingUS.[FinMarginPercent] AS decimal (20,2)) as [FinMarginPercent] 
,   NULL AS [FiscalYear]
...
--,   docBilling.[ShipToParty]
,   NULL AS [BillToParty]
,   CAST (docBillingUS.[QuantitySold] AS decimal (20,2)) as [QuantitySold] 
,   CAST (docBillingUS.[GrossMargin] AS decimal (20,2)) as [GrossMargin] 
...
,   CAST (docBillingUS.[FinNetAmount] AS decimal (20,2)) as [FinNetAmountRealProduct]  
,   CAST (docBillingUS.[FinNetAmountFreight] AS decimal (20,2)) as [FinNetAmountFreight] 
,   CAST (docBillingUS.[FinNetAmountMinQty] AS decimal (20,2))as [FinNetAmountMinQty] 
,   CAST (docBillingUS.[FinNetAmountEngServ] AS decimal (20,2)) as [FinNetAmountEngServ] 
,   CAST (docBillingUS.[FinNetAmountMisc] AS decimal (20,2)) as [FinNetAmountMisc] 
,   CAST (docBillingUS.[FinNetAmountServOther] AS decimal (20,2)) as [FinNetAmountServOther] 
,   CAST (docBillingUS.[FinNetAmountVerp] AS decimal (20,2)) as [FinNetAmountVerp] 
,   CAST (docBillingUS.[FinRebateAccrual] AS decimal (20,2)) as [FinRebateAccrual] 
,   CAST (docBillingUS.[FinReserveCashDiscount] AS decimal (20,2)) as [FinReserveCashDiscount] 
,   CAST (docBillingUS.[FinSales100] AS decimal (20,2)) as [FinSales100] 
,   CAST (docBillingUS.[FinNetAmountOtherSales] AS decimal (20,2)) as [FinNetAmountOtherSales] 
,   CAST (docBillingUS.[FinNetAmountAllowances] AS decimal (20,2)) as [FinNetAmountAllowances] 
...
,   CAST (docBillingBudget.[FinSales100] AS decimal (20,2)) as [FinSales100] 
...
--,   NULL AS [BillingQuantityUnitID]
--,   NULL AS [BillingQuantityUnit]
,   CAST (docBillingBudget_US.[NetAmount] AS decimal (20,2)) as [NetAmount] 
...
,   NULL AS [FinRebateAccrual]
,   NULL AS [FinReserveCashDiscount]
,   CAST (docBillingBudget_US.[FinSales100] AS decimal (20,2)) as [FinSales100] 
,   NULL AS [FinNetAmountOtherSales]
,   NULL AS [FinNetAmountAllowances]
,   NULL AS [axbi_DataAreaID]
,   NULL AS [axbi_DataAreaName]
