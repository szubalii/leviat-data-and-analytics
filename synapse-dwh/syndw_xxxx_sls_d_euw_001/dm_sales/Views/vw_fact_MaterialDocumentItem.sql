CREATE VIEW [dm_sales].[vw_fact_MaterialDocumentItem]
    ...
    , MDI_axbi.[SalesOrderScheduleLine]
    ...
    , MDI_axbi.[HDR_DeliveryDocumentTypeID]
    ...
    , CASE WHEN ISNULL(MDI_axbi.[PurchaseOrder],'') <>'' AND dimPD.[PurchasingDocumentTypeID] = 'STO' 
        THEN  MDI_axbi.[MatlStkChangeQtyInBaseUnit]
        ELSE NULL
      END                                                                        AS [ConsumptionQtySTOInBaseUnit]
    , dimPD.[PurchasingDocumentTypeID]                                           AS [PurchaseOrderTypeID]
    , dimPD.[PurchasingDocumentTypeName]                                         AS [PurchaseOrderType]
    ...
    , MDI_axbi.[ConsumptionQtyOBDProStandardValue]
    , MDI_axbi.[ConsumptionQtyOBDProStandardValue_EUR]
    ...
    , MDI_axbi.[QuantityInBaseUnitStandardValue]
    , MDI_axbi.[QuantityInBaseUnitStandardValue_EUR]
