...
WITH original AS (
    SELECT doc.[BillingDocument]
         ...
         , CAST (doc.[BillingQuantity] AS decimal (20,2)) as [BillingQuantity] 
         ...
         , CAST (doc.[NetAmount] AS decimal (20,2)) as [NetAmount] 
         , doc.[TransactionCurrencyID]
         , CAST (doc.[GrossAmount] AS decimal (20,2)) as [GrossAmount] 
         , doc.[PricingDate]
         , CAST (doc.[TaxAmount] AS decimal (20,2)) as [TaxAmount] 
         , CAST (doc.[CostAmount] AS decimal (20,2)) as [CostAmount] 
         , CAST (doc.[ProfitMargin] AS decimal (20,2)) as [ProfitMargin] 
         , CAST (doc.[MarginPercent] AS decimal (20,2)) as [MarginPercent] 
         , CAST (doc.[FinProfitMargin] AS decimal (20,2)) as [FinProfitMargin] 
         , CAST (doc.[FinMarginPercent] AS decimal (20,2)) as [FinMarginPercent] 
         , CAST (doc.[Subtotal1Amount] AS decimal (20,2)) as [Subtotal1Amount] 
         , CAST (doc.[Subtotal2Amount] AS decimal (20,2)) as [Subtotal2Amount] 
         , CAST (doc.[Subtotal3Amount] AS decimal (20,2)) as [Subtotal3Amount] 
         , CAST (doc.[Subtotal4Amount] AS decimal (20,2)) as [Subtotal4Amount] 
         , CAST (doc.[Subtotal5Amount] AS decimal (20,2)) as [Subtotal5Amount] 
         , CAST (doc.[Subtotal6Amount] AS decimal (20,2)) as [Subtotal6Amount] 
         , CAST (doc.[SalesOrganizationCurrency] AS decimal (20,2)) as [SalesOrganizationCurrency] 
         , CAST (doc.[EligibleAmountForCashDiscount] AS decimal (20,2)) as [EligibleAmountForCashDiscount] 
         --, doc.[PaymentMethod]
         ...
         , CAST (doc.[QuantitySold] AS decimal (20,2)) as [QuantitySold] 
         , CAST (doc.[GrossMargin] AS decimal (20,2)) as [GrossMargin] 
         ...
         --, doc.[BillTo]
         , CAST (doc.[FinNetAmountRealProduct] AS decimal (20,2)) as [FinNetAmountRealProduct] 
         , CAST (doc.[FinNetAmountFreight] AS decimal (20,2)) as [FinNetAmountFreight] 
         , CAST (doc.[FinNetAmountMinQty] AS decimal (20,2)) as [FinNetAmountMinQty] 
         , CAST (doc.[FinNetAmountEngServ] AS decimal (20,2)) as [FinNetAmountEngServ] 
         , CAST (doc.[FinNetAmountMisc] AS decimal (20,2)) as [FinNetAmountMisc] 
         , CAST (doc.[FinNetAmountServOther] AS decimal (20,2)) as [FinNetAmountServOther] 
         , CAST (doc.[FinNetAmountVerp] AS decimal (20,2)) as [FinNetAmountVerp] 
         , CAST (doc.[FinRebateAccrual] AS decimal (20,2)) as [FinRebateAccrual] 
         , CAST (doc.[PaymentTermCashDiscountPercentageRate] AS decimal (20,2)) as [PaymentTermCashDiscountPercentageRate] 
         , CAST (doc.[FinNetAmountOtherSales] AS decimal (20,2)) as [FinNetAmountOtherSales] 
         , CAST (doc.[FinReserveCashDiscount] AS decimal (20,2)) as [FinReserveCashDiscount] 
         , CAST (doc.[FinNetAmountAllowances] AS decimal (20,2)) as [FinNetAmountAllowances] 
         , CAST (doc.[FinSales100] AS decimal (20,2)) as [FinSales100] 
         , doc.[AccountingDate]
         , doc.[axbi_DataAreaID]                     
