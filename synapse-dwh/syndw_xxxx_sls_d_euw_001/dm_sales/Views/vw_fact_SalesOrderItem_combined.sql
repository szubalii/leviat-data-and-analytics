...
SELECT
    ...
    ,edw.[svf_getOrderStatus] (BDI.BillingDocument,OS.Status_Open,OS.Status_Closed,SOI.OrderStatus) AS OrderStatus
    ,edw.[svf_getOrderStatus] (BDI.BillingDocumentItem,OS.Status_Open,OS.Status_Closed,SOI.ItemOrderStatus) AS ItemOrderStatus
    ,SOI.[OrderType]
...
LEFT JOIN base_ff.OrderStatus OS
    ON SOI.SalesDocumentTypeID = OS.SalesDocumentTypeID
