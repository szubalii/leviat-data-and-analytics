...
GO
ALTER TABLE [base_tx_crh_2_dwh].[DIM_INVENTTABLE] ADD  CONSTRAINT [DF_DIM_INVENTTABLE_DW_SourceCode]  DEFAULT ('Unknown') FOR [DW_SourceCode]
GO
ALTER TABLE [base_tx_crh_2_dwh].[DIM_INVENTTABLE] ADD  CONSTRAINT [DF_DIM_INVENTTABLE_DW_TimeStamp]  DEFAULT (getdate()) FOR [DW_TimeStamp]
GO